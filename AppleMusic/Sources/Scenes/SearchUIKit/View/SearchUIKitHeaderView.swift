...
class SearchUIKitHeaderView: UICollectionReusableView {
    
    // MARK: - Properties

    static let identifier = "SearchUIKitHeaderView"
...
extension SearchUIKitHeaderView {
    enum Metrics {
